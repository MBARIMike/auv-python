...
dorado_info["2025.161.00"] = {
    "program": f"{MBTSLINE}",
    "comment": (
        "Monterey Bay MBTS Mission - 16125G"
        " Biolume, ISUS, and LISST payloads removed "
        " - ctdToUse = ctd1 "
    ),
}
dorado_info["2025.203.00"] = {
    "program": f"{MBTSLINE}",
    "comment": (
        "Monterey Bay MBTS Mission - 20325G"
        " Biolume, ISUS, and LISST payloads removed "
        " - ctdToUse = ctd1 "
    ),
}
dorado_info["2025.225.00"] = {
    "program": f"{MBTSLINE}",
    "comment": (
        "Monterey Bay MBTS Mission - 22525G"
        " Biolume, ISUS, and LISST payloads removed "
        " - ctdToUse = ctd1 "
    ),
}
...
dorado_info["2026.202.00"] = {
    "program": f"{MBTSLINE}",
    "comment": (
        "Monterey Bay MBTS Mission - 20226G ISUS, and LISST payloads removed, attempted circling behavior at end of mission  - ctdToUse = ctd1 "
    ),
}
dorado_info["2026.237.01"] = {
    "program": f"{MBTSLINE}",
    "comment": (
